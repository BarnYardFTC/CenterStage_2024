...
public class Claws {
    ...
    Servo left_claw;
    Servo right_claw;
    final double LEFT_CLAW_CLOSED_POSITION = 0.5; // ToDo: find correct values
    final double LEFT_CLAW_OPENED_POSITION = 1; // ToDo: find correct values
    final double RIGHT_CLAW_CLOSED_POSITION = 0; // ToDo: find correct values
    final double RIGHT_CLAW_OPENED_POSITION = 1; // ToDo: find correct values
