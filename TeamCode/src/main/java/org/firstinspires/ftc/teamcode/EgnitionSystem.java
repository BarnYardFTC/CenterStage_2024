...
public class EgnitionSystem {
    ...
    /*
    ================================================================================
    Started making this class static. didn't finish yet
    ================================================================================
     */
    ...
    public static void init(DcMotor fl_wheel, DcMotor fr_wheel, DcMotor bl_wheel, DcMotor br_wheel, HardwareMap hardwareMap) {
        ...
        EgnitionSystem.imu = hardwareMap.get(IMU.class, "imu");
